            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-full md:w-2/3 p-4  ">
                <div className="text-[#000000CC]">
                  <h1 className="text-4xl ">Report a Bug</h1>

                  <p className="py-4">
                  If you have encountered a bug, copy the returned information and open a support ticket. There, paste the returned information or a screenshot (“prtsc” on your keyboard) and a description of what the issue is. Describe how you encountered the issue or any other relevant information that could help us replicate the problem ourselves.
                   <br></br><br></br>
Bug report tickets that have a precise time the bug appeared combined with detailed step-by-step instructions on how to reproduce the issue have a high chance of being fixed in the next site update. If more information is needed or the bug is not easy to fix, it will take longer depending on the other workloads.       <br></br><br></br>

A staff member can take up to 1-2 days to respond to you. Alternatively, look in our Forums (Assistance Requests) to see if others have had the same issue and if there is an unofficial fix for it already.       <br></br><br></br>

If you reported a bug that was not known before you will get the Bug Report achievement.
                  ...
                  <img
                    ...
                    src="https://www.royalroadcdn.com/public/knowledgeBase/image-AADAp9H5RxE.png.png?time=1648494704"
                  ></img>
                <p className="py-4">This is a tiered achievement, so please keep reporting any bugs you find.</p>
                </div>
              </div>
            </div>
          </div>
