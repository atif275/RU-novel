...
·         Giving Reputation to users <br></br><br></br>

·         Commenting on fictions <br></br><br></br>
...
·        Gaining new achievements*
                  ...
                  <p className="py-4">
                  Note that the higher or harder an achievement is to obtain, the more experience will be rewarded. This also goes for reputation levels. <br></br><br></br>

The experience rewards are purely cosmetic, and more visible than the reputation rewards. Where reputation decides the gem of your border, it is experience that decides what border you can use. Exceptions are the premium borders, those are separate. See the Border Listing. <br></br><br></br>
...
The borders obtainable via leveling up are the following.
                  ...
                  <img
                    ...
                    src="https://www.royalroadcdn.com/public/knowledgeBase/image-AACAGaUPRRE.png.png?time=1648299100"
                  ></img>
