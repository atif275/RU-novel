          ...
          <div className="row mb-4">
            ...
            <div className="flex flex-wrap">
              ...
              <div className= {` ${theme === 'dark' ? 'text-white' : 'text-[#000000CC] '}`}>
                  <h1 className="text-4xl ">The site is loading slowly

                  </h1>
               
                   <p className="py-4">You can check status.royalroad.com to see if the issue is specific to you, or if it is a general issue for the site. . If it is a general issue, then note that the staff is likely already aware of it and is already working on a solution.
           <br></br><br></br>
Otherwise, you can open a support ticket (recommended) or contact us by email. </p>
