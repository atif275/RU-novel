              ...
              <div className="w-full md:w-1/2 p-4  ">
                <div className="text-[#000000CC]">
                  ...
                  <p className="mt-5">
                    ...
                    <br></br>
                    We have both a monthly and yearly subscription-based premium
                    service available. This service's primary aim is simple: to
                    provide an alternate way to support the site's development
                    and get an advertisement-free experience.
                  </p>
                  ...
                  <ul className="ml-5 mt-5 list-disc">
                    <li className="mt-2">Ad-Free Experience</li>
                    <li className="mt-2">Push Notifications</li>
                    <li className="mt-2">Premium Badge</li>
                    <li className="mt-2">Golden Post Border</li>
                    <li className="mt-2">Full Reading History</li>
                  ...
                  <p className="py-4">
                    Our Author Premium subscription has been created with one
                    goal in mind: to provide our authors with high-level tools
                    and data at a low price, which could amount to a much larger
                    expense without our subscription support. For example,
                    analytics requires dedicated machines to gather, store,
                    analyze, and serve the data.
                  </p>

                  <ul className="ml-5 mt-5 list-disc">
                    <li className="mt-2">Everything From Reader Premium</li>
                    <li className="mt-2">Detailed Analytics</li>
                    <li className="mt-2">Review Push Notifications</li>
                    <li className="mt-2">Customizable Fiction Header</li>
                    <li className="mt-2">Epub Export</li>
                    <li className="mt-2">Find & Replace</li>
                    <li className="mt-2">Automatic Draft Saving</li>
                    <li className="mt-2">Chapter Import</li>
                  </ul>

                  <p className="py-4">
                    Other services in the works for this tier will only be
                    listed after they stop being in the testing stage.
                  </p>

                  <h1 className="text-[#337AB7] text-3xl mt-5 " id="subscribe">
                    Subscribe
                  </h1>

                  <p className="py-4">
                    The Premium service can be accessed using the following
                    link: http://royalroad.com/premium.<br></br>
                    <br></br>
                    The subscription can be monthly or yearly, which you can
                    decide by choosing the relevant tab in the top right corner
                    of the pricing. The yearly price on both tiers of the
                    premium is the equivalent of 10 months, giving you 2 months
                    for free. <br></br>
                    <br></br>
                    The payments and the subscription itself is handled through
                    PayPal. This means that you can easily subscribe or
                    unsubscribe anytime directly through your PayPal account.
                  </p>

                  <h1 className="text-[#337AB7] text-3xl mt-5 " id="unsubscribe">
                    Unsubscribe
                  </h1>

                  <p className="py-4">
                    To Unsubscribe from the Premium service, go to your
                    settings, then to the premium tab, then click 'Unsubscribe'.
                    If you can't find the page or are unable to unsubscribe for
                    some reason, don't hesitate to make a new support ticket at
                    http://royalroad.com/support with the category "Payments,"
