            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-full md:w-2/3 p-4  ">
                <div className="text-[#000000CC]">
                  <h1 className="text-4xl ">Contact the Staff
                  </h1>
               
                   <p className="py-4">If you have an account and have a question regarding something on the site, we recommend you reach out to us via a support ticket https://www.royalroad.com/support <br></br><br></br>

Alternatively, you can reach out via email at https://www.royalroad.com/contact <br></br><br></br>

We are more than happy to receive your requests and emails, however, there are a couple of other ways to get an answer to some of your questions as well. If your purpose for reaching out is something you think a community member can help you with, you can ask on the forums <br></br><br></br>

If your purpose is to provide a suggestion, you can state your suggestion on our feedback site, where other community members can also vote on the suggestion and show interest in it.
