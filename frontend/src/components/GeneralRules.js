                          ...
                          <div className="sui-search-box flex items-center border rounded-md p-2">
                            <div className="flex-grow">
                              <input
                                ...
                                autoComplete="off"
                                placeholder="Search for support page by writing its name"
            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-full md:w-2/3 p-4  ">
                <div className="text-[#000000CC]">
                  <h1 className="text-4xl ">General Rules</h1>
                  <p className="mt-5">
                    While certain content may be allowed within designated
                    chapters on the site, it is important to note that these
                    guidelines do not extend to other areas of the site. Please
                    familiarize yourself with our content guidelines and ensure
                    that you do not post any prohibited or restricted content in
                    any area outside designated chapters. It is crucial to
                    adhere to our content guidelines in all areas of the site,
                    except where explicitly specified as permissible within the
                    content guidelines for specific chapters.
                  </p>
                  <p className="mt-5">
                    Please also check our Terms of Service for prohibited ways
                    of interacting with and on the site.
                  </p>
                  <p className="mt-5">
                  ...
                  <ol className="ml-5 mt-5 list-decimal">
                    ...
                    <li className="py-2">
                      ...
                      other targeted groups, particularly if it is likely to
                      humiliate, intimidate, or harm a targeted individual or
                      group is prohibited.
                    </li>
                    <li className="py-2">
                      Manipulating fiction scores and rankings is strictly
                      prohibited. This includes but is not limited to, creating
                      alternate accounts to rate multiple times and trading high
                      ratings with other users.
                    </li>
                    <li className="py-2">
                      No spam. This includes links to other sites, nonsense
                      posts, shill posts, and repeat posts in multiple forums.
                    </li>
                    <li className="py-2">
                      Unless explicitly stated and permitted in a specific
                      subforum, refrain from sharing links to external platforms
                      or Discord servers on the forums.
                    </li>
                    <li className="py-2">
                      Avoid potential harmful interactions: be mindful of the
                      potential impact communication may have on the well-being
                      of others, and avoid it if you suspect it could be
                      harmful. If we judge an act to be intentional, we will ban
                      the aggressor.
                    </li>
                    <li className="py-2">
                      Insulting and attacking other users is not allowed. You
                      can disagree, but be polite and civil.
                    </li>
                    <li className="py-2">
                      Pedophilia of any kind is prohibited in all areas of the
                      site, including within fictions that have mature tags, or
                      on associated platforms.
                    </li>
                    <li className="py-2">
                      You may not impersonate other people or staff members. Any
                      fan account must be clear about the fact.
                    </li>
                    <li className="py-2">
                      If your account received any sort of moderation
                      action/restriction, you may not use an alt account to
                      bypass those restrictions. Any attempts to bypass
                      moderation actions with an alt account will result in a
                      permanent ban.
                    </li>
                    <li className="py-2">
                      Don’t act in bad faith toward the platform and users. If
                      we need to add a rule beyond what is written above because
                      of you, then there will be moderation action for it.
                    </li>
                    <li className="py-2">
                      Do not join or organize a group with a bad faith purpose.
                    </li>
                  </ol>
                  <p className="mt-5">
                  Remember that while some interactions are appropriate for the forums, they are not appropriate in the comment section of a novel. You must follow our rules, but if an author decides to add additional rules for their comment section, make sure to respect those rules as the authors have the right to moderate their own chapters. 
                  </p>
                </div>
              </div>
            </div>
