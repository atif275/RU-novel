    ...
    <div className="flex-grow p-4 bg-gray-200">
      ...
      <div className="bg-white shadow rounded">
        <div className="flex justify-between items-center mb-4 border-b border-gray-300 pb-4 p-4">
          ...
          {ads.length < 4 && ( // Disable button if there are 4 or more ads
            <button
        ...
        <div className="p-4">
                    {ads.length === 0 ? (
                        ...
                        <table className="min-w-full text-sm divide-y divide-gray-200">
                            <thead>
                                <tr>
                                    <th className="bg-gray-50 px-6 py-3 text-left font-medium ">Id</th>
                                    <th className="bg-gray-50 px-6 py-3 text-left font-medium ">Title</th>
                                    <th className="bg-gray-50 px-6 py-3 text-left font-medium ">Advertisements</th>
                                    <th className="bg-gray-50 px-6 py-3 text-left font-medium  ">Actions</th>
                                </tr>
                            </thead>
                            <tbody  className="bg-white divide-y divide-gray-200">
                                {ads.map(ad => (
                                    <AdContent key={ad._id} id={ad.id} title={ad.title} image={ad.image} link = {ad.link} />
                                ))}
                            </tbody>
                        </table>
                    )}
