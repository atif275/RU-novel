            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-full md:w-1/2 p-4  ">
                <div className="text-[#000000CC]">
                  <h1 className="text-4xl ">Fiction Status</h1>

                  

                  <h1 className="text-[#337AB7] text-3xl mt-5 " id="fiction-status">
                  Fiction Status
                  ...
                  <img
                    ...
                    src="https://www.royalroadcdn.com/public/knowledgeBase/image-AABAYCyCRBE.png.png?time=1648262013"
                  ></img>

                  <p className="py-4">
                  Fictions on the site have 5 possible statuses: Ongoing, Completed, Hiatus, Stub, and Dropped.
                  </p>
...
<p class="py-4"><strong>C</strong>ompleted: Authors can set their fiction as complete. Complete fictions are not expected to receive more updates in the future and are complete works. If a chapter was added, the complete status would not be changed.</p>
                  ...
                  <h1 className="text-[#337AB7] text-3xl mt-5 " id="manually-change">
                  Manually Change the status
                  </h1>
                  <p className="py-4">
                  In order to do so, you need to:<br></br>
1. Go to the <Link to="/support/knowledgebase/author-dashboard" className="text-blue-700"> Author </Link> Dashboard<br></br>
