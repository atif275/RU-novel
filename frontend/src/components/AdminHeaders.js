               ...
               <li className="relative block mt-5" ref={messagedownRef} >
                ...
                <li className="relative group" ref={dropdownRef}>
                  ...
                  {dropdownVisible && (
                    ...
                    >
                      <li>
                        <Link to="/admin/account" className="flex items-center px-3 py-1 hover:bg-[#55616f]" onClick={() => setDropdownVisible(false)} >
                      ...
                      <li>
                        <Link to="/admin/private/1" className="flex items-center px-3 py-1 hover:bg-[#55616f]"onClick={() => setDropdownVisible(false)} >
            ...
            {isAuthenticated ? (
              ...
              <div className="relative">
                ...
                {dropdownVisible && (
                  ...
                  >
                    <li>
                      <Link to="/admin/account" className="flex items-center px-3 py-1 hover:bg-[#55616f]">
                        <FontAwesomeIcon icon={faUser} className="mr-2 text-[#6fa7d7]" />
                        My Profile
                      </Link>
                    </li>
                    ...
                    <li>
                      <Link to="/admin/private/1" className="flex items-center px-3 py-1 hover:bg-[#55616f]">
                        <FontAwesomeIcon icon={faEnvelopeOpen} className="mr-2 text-[#6fa7d7]" />
                        Inbox
                      </Link>
                    </li>
