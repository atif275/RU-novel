...
import { FaPen, FaEnvelope, FaLock, FaCogs } from "react-icons/fa";
            ...
            <div className="container pt-2 mx-auto sm:px-6 sm:pr-4 bg-gray-100 w-full pb-8 shadow-lg">
                ...
                <div className="relative flex h-[130px] items-center p-4 bg-opacity-50 bg-[url(https://www.royalroad.com/dist/img/collaborators_header.jpg)] bg-cover ">
                    ...
                    <div className="absolute left-0 ml-10 flex items-center">
                        <FaLock className="text-white text-6xl mr-4" />{" "}
                        ...
                        <div className="bg-white shadow-lg mt-4  p-6">
                            ...
                            <div className="bg-blue-100 border border-blue-300 p-4">
                                <p className="text-custom-blue">
                                    Your account has no password associated with it; please use the
                                    <a
                                        href="/login" 
                                        className="bg-custom-blue text-white px-2 py-1 mr-2 ml-2 inline-block"
                                    >
                                        Password Reset
                                    </a>
                                    feature to send a password recovery email to your associated email address.
                                </p>
                            </div>
                        </div>
                    </div>
