        ...
        {myOptions.map((option, index) => (
            ...
            >
                ...
                ></i>  <div className={`flex-grow  ${sidebarcollapse ? 'inline-block' : 'hidden'} sm:inline-block`}>{option.label}</div>   </Link>
                    ...
                    <div className="flex-1 ml-4 mt-4 h-[1200px] ">
                            ...
                            <div className="w-full">
                                <table className="min-w-full divide-y divide-gray-200">
                                    <thead className="bg-gray-200">
                                        <tr>
                                            <th scope="col" className="md:px-[20px] px-[10px] py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                 Title
                                            </th>
                                            <th scope="col" className="md:px-[20px] px-[10px] py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                Sender
                                        ...
                                        {currentFilteredMessages.map((message) => (
                                            <React.Fragment key={message._id}>
                                                <tr className="hover:bg-gray-50" onClick={() => toggleMessageDetails(message.subject)}>
                                                    <td className="md:px-[20px] px-[10px] py-4 whitespace-nowrap text-sm font-medium text-gray-900 cursor-pointer">
                                                        {message.subject}
                                                    </td>
                                                    <td className="md:px-[20px] px-[10px] py-4 whitespace-nowrap text-sm text-gray-500">
                                                ...
                                                {selectedSubject === message.subject && (
                                                    <tr className="bg-gray-50">
                                                        <td colSpan="4" className="md:px-[20px] px-[10px] py-4 whitespace-wrap text-sm text-gray-800">
