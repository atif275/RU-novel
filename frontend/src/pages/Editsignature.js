...
import { FaList, FaHome, FaCogs } from "react-icons/fa";
            ...
            <div className="container pt-2 mx-auto sm:px-6 sm:pr-4 bg-gray-100 w-full pb-8 shadow-lg">
                ...
                <div className="relative flex h-[130px] items-center p-4 bg-opacity-50 bg-[url(https://www.royalroad.com/dist/img/collaborators_header.jpg)] bg-cover ">
                    ...
                    <div className="absolute left-0 ml-10 flex items-center">
                        <FaList className="text-white text-6xl mr-4" />{" "}
                        {/* Ensure you have imported FaEnvelope */}
                        <div>
                            <h2 className="text-white text-2xl">Edit Signature</h2>
                ...
                <div className="flex mt-4">
                    ...
                    {/* mian div  */}
                    <div className="flex-1 ml-4 mt-4 sm:h-auto  h-[1300px]">
...
<div className="bg-white shadow-lg rounded-lg p-6">
    ...
    <div className="flex justify-center items-center mt-4 space-x-4">
        <button className="bg-custom-blue text-[10px] sm:text-[12px] text-white sm:px-4 sm:py-2 px-1 py-1  hover:custom-hover-blue">
            Save Changes
        </button>
        <button className="bg-red-500 text-[10px] sm:text-[12px] text-white sm:px-4 sm:py-2 px-1 py-1   hover:bg-red-600 flex items-center">
            <i className="fas fa-magic mr-2"></i>
            Generate for my Fictions
        </button>
    </div>
