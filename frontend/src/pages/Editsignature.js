                    ...
                    <div className="flex-1 ml-4 mt-4">
                        ...
                        <div className="bg-white shadow-lg rounded-lg p-6">
                            ...
                            <div className="flex justify-center items-center m-4 space-x-4">
                                <button className="bg-custom-blue text-white px-4 py-2 hover:custom-hover-blue">
                                    Save Changes
                                </button>
                                <button className="bg-red-500 text-white px-4 py-2 hover:bg-red-600 flex items-center">
