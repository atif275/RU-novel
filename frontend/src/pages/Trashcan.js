...
//                                 />
//                                 <button className="bg-custom-blue hover:bg-blue-600 text-white py-2 px-4 ">
//                                     Go
//                                 </button>
//                             </div>
//                             <div>
...
//                             </div>
//                             <div className="flex mt-4">
//                                 <button className="bg-gray-300 hover:bg-gray-400 text-black py-2 px-4  mr-2">
//                                     Move to
//                                 </button>
...
//                                 </select>
//                                 <button className="bg-red-500 hover:bg-red-600 text-white py-2 px-4  ml-2">
//                                     Delete
//                                 </button>
//                             </div>
//                         </div>
...
function Trashcan() {
    ...
    const fetchMessages = async () => {
        ...
        try {
            const response = await axios.get(`https://api.ru-novel.ru/api/messages/trashcan/${currentUser.username}`, {
                params: {
                    status: 'sent',
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full divide-y divide-gray-200">
                                    <thead className="bg-gray-200">
                                        <tr>
                                            <th scope="col" className="sm:px-6 sm:py-3 px-[10px] py-[10px] text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                Title
                                            </th>
                                            <th scope="col" className="sm:px-6 sm:py-3 px-[10px] text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                Sender
                                            </th>
                                            <th scope="col" className="sm:px-6 sm:py-3 px-[10px] text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                Date
